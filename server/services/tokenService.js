...
exports.generateAccessToken = id => jwt.sign({ id: (id || '').toString() }, getSecret(), { expiresIn: getExpire() });
exports.generateRefreshToken = id => jwt.sign({ id: (id || '').toString() }, getRefreshSecret(), { expiresIn: getRefreshExpire() });
